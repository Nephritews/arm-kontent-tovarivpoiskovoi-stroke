...
* Введите свойства. Имеется два типа свойств:  Приоритет (PRIORITY) (работает с лева на право) и Ссылка (LINK) (определяет отношения между текущим свойством и сайтом))
