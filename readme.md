...
Актиновсти разделов делятся на два типа: промышленный и тестовый сервер.
...
# Удаление данных.
* При удаление элементов, нажмите на икону корзины. В открывшемся окне, нажмите кнопку ок.
