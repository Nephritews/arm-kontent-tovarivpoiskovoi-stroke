...
Активности для промышленого и тестового сервиса .Используются, чтобы указать их активность для пром или тест сервера, и даты их активность ограничивающую.
