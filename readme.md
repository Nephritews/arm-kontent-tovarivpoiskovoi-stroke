...
### Пример
Был создан блок с товарами в поисковой строке. Сначала будем его проверять на дев версии сайта. Для этого будет указан дев сервер и даты начала и конца активности этого блока. Дата нужна для того, чтобы можно было указать, в каком временном диапазоне этот блок используется, (например, в следующем месяце).
![23](https://user-images.githubusercontent.com/85296765/123373209-0fb0fc80-d596-11eb-81d4-6267f9bd8ce1.png)
# Элементы.
...
![56](https://user-images.githubusercontent.com/85296765/123375997-c911d100-d59a-11eb-9fbd-26756f8141f8.png)
* Вкладка свойства.
